...
public class StockList
{
    ...
    public void buyProduct(int productID, int amount)
    {
        ...
        if(product != null) 
        {
            if(product.getQuantity() < 1000)
            {
                ...
                // printout message
                System.out.println("You have purchased " + amount + " of " + product.getName());
            }
            else
            {
                // printout message
                System.out.println("We cannot hold this amount of items. " + product.getName());
            }
        }
        else
        {
            // printout message
            System.out.println(" We do not have this item currently in stock ");
        }
    }
    ...
    public void sellProduct(int productID, int amount)
    {
        ...
        if(product != null) 
        {
            ...
            {
                System.out.println( product.getName() + " We do not have enough prouct to satisfy your order ");
            }
            else
            {
                // printout message
    ...
    {
        System.out.println();
        System.out.println(" Convinence Store :) ");
        System.out.println(" =+=+=+=+=+=+=+=+=+=+=");
        System.out.println();
    }
